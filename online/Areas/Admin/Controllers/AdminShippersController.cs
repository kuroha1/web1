...
namespace online.Areas.Admin.Controllers
{
    ...
    public class AdminShippersController : Controller
    {
        ...
        public AdminShippersController(newDataContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Shippers != null ? 
                          ...
                          Problem("Entity set 'newDataContext.Shippers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'newDataContext.Shippers'  is null.");
            }
            var shipper = await _context.Shippers.FindAsync(id);
            if (shipper != null)
            {
