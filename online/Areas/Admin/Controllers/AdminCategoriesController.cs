...
namespace online.Areas.Admin.Controllers
{
    ...
    public class AdminCategoriesController : Controller
    {
        ...
        public AdminCategoriesController(newDataContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categories != null ? 
                          ...
                          Problem("Entity set 'newDataContext.Categories'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'newDataContext.Categories'  is null.");
            }
            var category = await _context.Categories.FindAsync(id);
            if (category != null)
            {
